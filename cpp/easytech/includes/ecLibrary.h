...
const char *GetDocumentPath(char const *FileName);
...
struct ecTextureRes {
    ...
    ecImage *GetImageByFormat(const char *Format, ...);
...
struct ecImage {
    ...
    void RenderEx(float x, float y, float offset, float xFactor, float yFactor);
...
void _ZN9ecUniFont4InitEPKcb(struct ecUniFont *self, const char *name,bool);
...
extern struct ecUniFont g_Num3;
extern struct ecUniFont g_Num4;
extern struct ecUniFont g_Font1;
...
struct ecEffect {
    ...
    void FireAt(float, float, float);
    void MoveTo(float, float, bool);
    void Stop(bool);

#ifdef extends_ecEffect
    extends_ecEffect
#endif
#endif
};
...
void _ZN8ecEffect6FireAtEfff(struct ecEffect *self, float, float, float);
void _ZN8ecEffect6MoveToEffb(struct ecEffect *self, float, float, bool);
void _ZN8ecEffect4StopEb(struct ecEffect *self, bool);
