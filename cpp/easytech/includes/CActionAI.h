...
struct CActionAssist {
    ...
    bool NewAiCheckAttackAble(int StartAreaID, int TargetAreaID, int ArmyIndex, int ArmyAreaID);

    void actionToNextArea(int mode, int targetAreaID, int ArmyIndex, int);
    ...
    bool getAlliance(int startAreaID, int targetAreaID, int mode);
    ...
    int searchNodeByID(int startAreaID, int ArmyIndex);
