...
#include "../CScene.h"
//新卡牌
__sub_struct(GUICard, GUIElement)
    void SetPrice(int money);
void SetIndustry(int industry);
    unsigned char unknown[0x128u - sizeof(GUIElement)];
#ifdef __cplusplus
    void Init(CardDef *,GUIRect const&);
    void SetPriceColor(u_long color);
    void SetIndustryColor(u_long color);
#ifdef extends_GUICardList
    extends_GUICardList
#endif
#endif
__end_struct
__BEGIN_DECLS
void _ZN7GUICardC2Ev(struct GUICard *self);
void _ZN7GUICard4InitEP7CardDefRK7GUIRect(struct GUICard *self,CardDef *,GUIRect const&);
void _ZN7GUICard13SetPriceColorEm(GUICard *self, u_long color);
void _ZN7GUICard16SetIndustryColorEm(GUICard *self, u_long color);
__END_DECLS


__sub_struct(GUICardList, GUIElement)
    vector<struct GUICard *> data;
#ifdef __cplusplus
    GUICard* GetCard(int index);
    void Init(GUIRect const&,int);
...
__end_struct
__BEGIN_DECLS
void _ZN11GUICardList4InitERK7GUIRecti(struct GUICardList *self, GUIRect const&,int);
GUICard* _ZN11GUICardList7GetCardEi(GUICardList *self, int index);
__END_DECLS
///////////////////////////
struct GUIGold;
